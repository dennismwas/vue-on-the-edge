  ...
  <div>
    ...
    <main>
      ...
      <div class="info">
       ...
       <div class="debug">Generated at {{ new Date().toISOString() }}</div>
         <footer>
        <p class="company">
...
const city = computed(() => parsedCity.value === 'null' ? "Cannot get city." : parsedCity.value);
const ip = ref((pageContext.headers['x-forwarded-for'] ?? '127.0.0.1').split(',')[0]);
